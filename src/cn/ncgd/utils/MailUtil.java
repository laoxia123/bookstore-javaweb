...
public class MailUtil {
	public static void sendMail(String to,String code){
		...
		try {
			...
			// 设置邮件的正文:
			message.setContent("<h1>欢迎来到ESTROE购物天堂</h1><h3><a href='http://192.168.1.100/estore/user?method=active&code="+code+"'>http://192.168.1.100/estore/user?method=active&code="+code+"</a></h3>", "text/html;charset=UTF-8");
			// 发送邮件:
